...
<body>
    ...
    <ul class="nav nav-tabs">
        <li><a class="text-uppercase" href="row_data.html">PETITIONER </a></li>
        <li><a class="text-uppercase" href="r_victim.html">victim </a></li>
        <li class="dropdown open"><a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true" href="#">ENTRY </a>
        ...
        <li><a href="r_section of low.html">SECTION OF LOW</a></li>
    </ul>
